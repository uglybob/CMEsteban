...
abstract class Brausehaus extends Page {
    // {{{ hookTitle
    protected function hookTitle() {
        return 'Brausehaus &#183; ' . $this->title;
    }
    // }}}

    // {{{ hookHeader
    protected function hookHeader() {
        return  HTML::link('rel="shortcut icon" href="/Images/favicon.ico" type="image/vnd.microsoft.icon"') .
                HTML::meta('name="description" content=\'The name "Brausehaus" stands for our underground music-collective.\'');
        // @todo HTML::meta('name="keywords" content="Brausehaus,Potsdam,Band,Music,' . implode(',', $this->controller->getBandList()) . '"') .
    }
    // }}}
    // {{{ renderStylesheets
